...
header.masthead {
    ...
    background: url('image/Litografi.jpg') no-repeat center center;
...
.mybg-events {
    background: url('image/ml.jpg') no-repeat center center fixed;
    background-size: cover;
}
.h-262 {
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">PRO<span class="my-heading">FIL</span></h3>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="bio-image">
                                                  <img src="image/dinda.jpeg" width="200px" alt="image" />
                                              </div>			
                                          </div>
                                      </div>	
                                  </div>
                                  <div class="col-md-6">
                                      <div class="bio-content">
                                          <h1 style="color:basic;">BIODATA</h1>
                                <br>
                                          <h5 style="color:warning;">Nama : Riska Adinda Darurroihah</h5><h5 style="color:warning;"> Kelas : XII RPL-2</h5 style="color:warning;"><h5 style="color:warning;"> Jurusan : Rekayasa Perangkat Lunak</h5><h5 style="color:warning;">Sekolah : SMKN 1 Purwosari</h5><h5 style="color:warning;"> Tempat/Tanggal Lahir : Pasuruan, 31 Desember 2003</h5>
                                <h5 style="color:warning;">Alamat : Rt/Rw 02/02 Dsn.Jatitengah Ds.Mojotengah</h5>
                              </div>
                                  </div>
                              </div>	
                          </div>
