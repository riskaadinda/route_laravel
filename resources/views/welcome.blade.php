...
header.masthead {
    ...
    background: url('image/Dewi.jpg') no-repeat center center;
...
.mybg-events {
    background: url('image/malam2.jpg') no-repeat center center fixed;
    background-size: cover;
}
.h-262 {
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">LARA<span class="my-heading">VEL</span></h3>
